...
//               <div>
//                 <button
//                   className={`text-left px-4 py-2 rounded w-full ${activeTab === 'leads' ? 'bg-blue-600 text-white' : 'bg-white border'}`}
//                   onClick={() => {
...
//                     <button
//                       className={`text-left px-4 py-1 block w-full rounded ${leadSubTab === 'active' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
//                       onClick={() => setLeadSubTab('active')}
//                     >
//                       Active
//                     </button>
//                     <button
//                       className={`text-left px-4 py-1 block w-full rounded mt-1 ${leadSubTab === 'submitted' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
...
//             {activeTab === 'suppliers' && (
//               <>
//                 <h3 className="text-xl font-semibold mb-4">Clients / Suppliers List</h3>
...
//       // Revert optimistic UI if update fails
//       setLeads((prevLeads) =>
//         prevLeads.map((lead) =>
